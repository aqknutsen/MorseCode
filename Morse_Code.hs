...
-- Hint: stringB = 7L4LMNOPQRS4LNO
inputStringA = "..--- -- .- --. -. ..-. -.-. .--. -.-. -... -.- -.-. --.- --.- ----. . -.-. ..- --. .-. ..-. .--- -.-. .-. .-. -.-. .--. --.- ----. .-.. -... .-.. ... -.- ----- -.-. .--. -..- ---.. -.-- --.. .---- ..--- ...-- ....- ..... -...."
inputStringB = ".---- -- ---.. -- ..... -- -. --- .--. --.- .-. ... - ..... -- --- .--."
inputStringC = "---.. ----. -- ..-. - -.-. ...- .---- ---.. -.. -.-. -.-- ---.. .- . -..- .- .... ..... ---.. --... --.. ....- -..- .... -..."
main = do
	let pUnmorsed = (fromMorseCode inputStringA)
	putStrLn $ "input as morse: " ++ inputStringA
	putStrLn $ "converted to characters: " ++ pUnmorsed
	putStrLn $ "character 0 (key): " ++ [(pUnmorsed !! 0)]
	putStrLn $ "character 1 (M)  : " ++ [(pUnmorsed !! 1)]
	putStrLn $ "to decipher      : " ++ (drop 2 pUnmorsed)
	putStrLn $ ""
	putStrLn $ "stringA      : " ++ (decodeText inputStringA)
	putStrLn $ "stringB      : " ++ (decodeText inputStringB)
	putStrLn $ "stringC      : " ++ (decodeText inputStringC)